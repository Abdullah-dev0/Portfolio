...
const AboutMe = () => {
	const aboutPageStructuredData = {
		...
		mainEntity: {
			...
			description:
				"Full Stack Developer passionate about creating exceptional web experiences. I love building interactive and responsive applications using modern technologies.",
			url: "https://abdullahtech.me/about",
			worksFor: {
				"@type": "Organization",
				name: "Biz of Dev",
				url: "https://bizofdev.com/",
			},
			knowsAbout: [
	...
	return (
		<>
			<SEOHead
				...
				description="Learn more about Abdullah - Full Stack Developer passionate about creating exceptional web experiences. I love building interactive and responsive applications using modern technologies."
				keywords={[
					"About Abdullah",
