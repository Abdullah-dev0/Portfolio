...
import { generateArticleStructuredData, sanitizeMetaDescription } from "@/utils/seo-helpers";
...
const BlogDetails = () => {
	...
	if (!blog) {
		return (
			<div className="section-spacing">
				<SEOHead
					title="Blog Not Found | Abdullah"
					description="The blog post you're looking for doesn't exist. Explore other insightful articles on web development and programming."
	...
	const blogStructuredData = generateArticleStructuredData({
		title: blog.title,
	...
	return (
		<>
			<SEOHead
				title={`${blog.title} | Abdullah's Blog`}
				description={sanitizeMetaDescription(blog.description)}
				keywords={[
					"Abdullah Blog",
					"Web Development",
			...
			<div className="space-y-8">
				...
				<div className="space-y-6 slide-up">
					<div className="space-y-4">
						<h1 className=" text-xl sm:text-2xl md:text-4xl font-bold leading-tight">{blog.title}</h1>
