...
import { generateSoftwareProjectStructuredData, sanitizeMetaDescription } from "@/utils/seo-helpers";
...
const ProjectDetails = () => {
	...
	if (!project) {
		return (
			<div className="section-spacing">
				<SEOHead
					title="Project Not Found | Abdullah"
					description="The project you're looking for doesn't exist. Explore other amazing projects showcasing modern web development skills."
					url={`/projects/${slug}`}
					type="website"
				/>
	...
	const projectStructuredData = generateSoftwareProjectStructuredData({
		name: project.slug,
	...
	return (
		<>
			<SEOHead
				title={`${project.slug} | Abdullah's Projects`}
				description={sanitizeMetaDescription(project.description)}
				keywords={[
					"Abdullah Projects",
					project.slug,
					"Web Development",
