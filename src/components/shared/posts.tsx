...
const Posts = ({ slug, description, date, isExternal }: Post) => {
	return (
		<article className="group card-spacing card-subtle card-hover relative overflow-hidden border border-slate-300/10 rounded-lg p-4 transition-transform transform">
